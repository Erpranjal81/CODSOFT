...
int main() {
    ...
    std::cout << "Welcome to the  Number Guessing Challenge!\n";
    ...
    do {
        ...
        if (std::cin.fail()) {
            std::cout << "uh-oh! That's not a valid number. Please enter a whole number.\n";
            std::cin.clear();
            std::cin.ignore(256, '\n');
            continue;
        }
        ...
        if (guess > SECRET_NUMBER) {
            ...
            std::cout << "\n Bullseye! You nailed it! The secret number was " << SECRET_NUMBER << ".\n";
